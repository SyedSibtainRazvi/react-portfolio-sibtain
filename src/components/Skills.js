    ...
    <div name="skills" className="w-full h-screen bg-[#F6F6F6] text-black">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          ...
          <div className="shadow-md hover:scale-110 duration-500">
            <img className="w-20 pt-4 mx-auto" src={Redux} alt="HTML icon" />
            <p className="my-4">REDUX</p>
          </div>
          <div className="shadow-md hover:scale-110 duration-500">
            <img className="w-20 pt-4 mx-auto" src={Tailwind} alt="HTML icon" />
            <p className="my-4">TAILWIND CSS</p>
          </div>
        </div>
        <div>
          <p className="py-4">
            I am currently exploring <b>Postgres, NextJS and Express</b>.
          </p>
        </div>
      </div>
    </div>
